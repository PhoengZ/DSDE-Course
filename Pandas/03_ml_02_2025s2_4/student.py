...
class BankLogistic:
    ...
    def Q2(self): # DO NOT modify this line
        ...
        """
        return (self.df.select_dtypes(include="number").shape[1], self.df.select_dtypes(include="object").shape[1])
    ...
    def Q3(self): # DO NOT modify this line
        ...
        """
        return (round(self.df.loc[self.df['y'] == 'no', :].shape[0]/self.df.shape[0],3), round(self.df.loc[self.df['y'] == 'yes', :].shape[0]/self.df.shape[0],3))
    ...
    def Q6(self): 
        ...
        smode = SimpleImputer(strategy="most_frequent")
        self.X_train[num_cols] = smean.fit_transform(self.X_train[num_cols])
        self.X_test[num_cols] = smean.transform(self.X_test[num_cols])
        self.X_train[cate_cols] = smode.fit_transform(self.X_train[cate_cols])
        self.X_test[cate_cols] = smode.transform(self.X_test[cate_cols])
        ...
        self.X_train = pd.get_dummies(self.X_train, cate_cols)
        self.X_test = pd.get_dummies(self.X_test, cate_cols)
